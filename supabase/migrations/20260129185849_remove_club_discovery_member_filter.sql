-- Remove minimum member count filter from get_nearby_clubs
-- This was preventing new clubs from being discoverable (chicken-and-egg problem)
...
COMMENT ON FUNCTION public.get_nearby_clubs IS 'Returns nearby clubs within radius, including member count and wine preferences. Distance calculated using Haversine formula. No minimum member count required for discoverability.';
